...
themeToggleBtn.addEventListener('click', () => {
    ...
    // Comentário Explicativo: O classList.toggle adiciona a classe se ela não existir,
    // e a remove se ela já estiver presente, alterando as variáveis CSS.
});
...
form.addEventListener('submit', function(event) {
    ...
    // 2. Validação do Campo E-mail com Regex (Expressão Regular)
    ...
    // Se tudo estiver correto (isValid continua true)
    if (isValid) {
